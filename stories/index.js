...
storiesOf('Alignment Plugin', module).add(
  'Editor with Alignment Plugin',
  () => <SimpleAlignmentEditor />
);

storiesOf('Anchor Plugin', module).add('Editor with Anchor Plugin', () => (
  <AnchorSimpleLinkPluginEditor />
));

storiesOf('Counter Plugin', module)
  .add('Editor with Counter Plugin', () => <SimpleCounterEditor />)
  .add('Editor with custom themed Counter Plugin', () => (
    <CustomCounterEditor />
  ));

storiesOf('DragNDrop Plugin', module).add(
  'Editor with DragNDrop plugin and image plugin',
...
storiesOf('Focus Plugin').add('Editor with Focus Plugin', () => (
  <SimpleFocusEditor />
));
...
storiesOf('Linkify Plugin')
  ...
  .add(
    'Editor with Linkify Plugin using a custom component to render the link',
