...
export default class Logo extends Component {
  ...
  render() {
    const classNames = [this.props.className, styles.logo].join(' ');
    const {animate} = this.props;

    const offsets = {
      penHandle: animate ? 228 : 0,
      penRing: animate ? 48 : 0,
      penTop: animate ? 85 : 0,
      drawnPath: animate ? 570 : 0,
    }

    return (
      <svg className={ classNames } viewBox="0 0 263 209" version="1.1">
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          <g id="Pencil" transform="translate(177.000000, 1.000000)" stroke="#979797" strokeWidth="2" fill="#FFFFFF">
              <path
                ...
                id="Path-2"
                strokeDasharray="228"
                strokeDashoffset={offsets.penHandle}
                ref="penHandle"
              ></path>
              <path
                ...
                strokeDasharray="48"
                strokeDashoffset={offsets.penRing}
                ref="penRing"
              ></path>
              <path
                ...
                id="Path-1"
                strokeDasharray="85"
                strokeDashoffset={offsets.penTop}
                ref="penTop"
              ></path>
          </g>
          <g id="Line" transform="translate(1.000000, 117.000000)" stroke="#979797">
              ...
              <path
                ...
                id="Path-5"
                strokeDasharray="570"
                strokeDashoffset={offsets.drawnPath}
                ref="drawnPath"
              >
              </path>
          </g>
