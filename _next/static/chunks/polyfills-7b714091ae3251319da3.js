      ...
      (function (t) {
        !(function () {
          ...
          var tt,
            ...
            Ft = z('wks'),
            Bt = o.Symbol,
            Dt = Ct ? Bt : (Bt && Bt.withoutSetter) || K,
            qt = function (t) {
              return (
                w(Ft, t) ||
                ...
                (g &&
                  ...
                  We !== Object.prototype &&
                    ...
                    (Te(u) !== We &&
                      (ze
                        ? ze(u, We)
                        : 'function' != typeof u[Ke] && T(u, Ke, Xe)),
                    Ne(u, l, !0))),
                o == Ve &&
                  d &&
                  d.name !== Ve &&
          ...
          if (
            ...
            Lt(
              ...
              { getOwnPropertyNames: Ka, getOwnPropertySymbols: $a }
            ),
            Lt(
              {
                target: 'Object',
                ...
                for (a += (f - i) * l, i = f, e = 0; e < t.length; e++) {
                  ...
                  if (r == i) {
                    for (var h = a, p = 36; ; p += 36) {
                      ...
                      var v = h - d,
                        g = 36 - d;
                      n.push(Wu(Gu(d + (v % g)))), (h = zu(v / g));
                    }
                    n.push(Wu(Gu(h))), (u = Ku(a, l, c == s)), (a = 0), ++c;
                  }
                }
                ++a, ++i;
              }
                  ...
                  case Ec:
                    r || '#' != i
                      ? i != gs &&
                        ("'" == i && Ys(t)
                          ? (t.query += '%27')
                          : (t.query += '#' == i ? '%23' : Hs(i, Gs)))
                      : ((t.fragment = ''), (c = xc));
                    break;
                  case xc:
                    i != gs && (t.fragment += Hs(i, Ks));
                }
                f++;
              }
            },
            ...
            Zf = function (t, e) {
              Lf.call(o, function () {
                ...
                if (
                  tl(e) &&
                  ((r = kf(function () {
                    Kf ? qf.emit('unhandledRejection', n, t) : Qf(Vf, t, n);
                  })),
                  (e.rejection = Kf || tl(e) ? 2 : 1),
                  r.error)
                )
                  throw r.value;
              });
          ...
          Hf &&
            ...
            (If.f = Wf = function (t) {
              return t === Ff || t === Of ? new Af(t) : Gf(t);
            }),
            'function' == typeof Kc &&
              ((Rf = Kc.prototype.then),
              rt(
                Kc.prototype,
                'then',
                function (t, e) {
          ...
          Lt(
            ...
            'function' != typeof Kc ||
              ...
              rt(Kc.prototype, 'finally', it('Promise').prototype.finally);
          var al = et.set,
