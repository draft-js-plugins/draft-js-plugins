      ...
      !(function (e) {
        (e.emojiList = {
          ...
          (e.convert = function (e) {
            if (e.indexOf('-') > -1) {
              for (var f = [], _ = e.split('-'), a = 0; a < _.length; a++) {
                var o = parseInt(_[a], 16);
            ...
            if ((_ = parseInt(e, 16)) >= 65536 && _ <= 1114111) {
              (s = Math.floor((_ - 65536) / 1024) + 55296),
                (t = ((_ - 65536) % 1024) + 56320);
        ...
        for (f in e.emojiList)
          if (e.emojiList.hasOwnProperty(f) || '' === f) {
            _.push(f.replace(/[+]/g, '\\$&'));
            var a = e.convert(e.emojiList[f].uc_full),
              o = 0;
            for (
              e.shortnameLookup[a] = f.replace(/[+]/g, '\\$&'), o = 0;
              o < e.emojiList[f].shortnames.length;
              o++
            )
              _.push(e.emojiList[f].shortnames[o].replace(/[+]/g, '\\$&')),
        ...
        (e.shortnames = _.join('|')),
          ...
          (e.shortnameToUnicode = function (f) {
            ...
            if (
              ((f = f.replace(e.regShortNames, function (f) {
                ...
                return (
                  (_ = e.emojiList[f].uc_full.toUpperCase()),
              ...
              var a = e.riskyMatchAscii ? e.regAsciiRisky : e.regAscii;
              f = f.replace(a, function (f, a, o, s) {
                return 'undefined' !== typeof s &&
                  '' !== s &&
                  e.unescapeHTML(s) in e.asciiList
                  ? ((s = e.unescapeHTML(s)),
                    (_ = e.asciiList[s].toUpperCase()),
                    o + e.convert(_))
                  : f;
              });
            }
            ...
            if (
              ((f = f.replace(e.regShortNames, function (f) {
                ...
                return (
                  ...
                  (s = e.unicodeAlt ? e.convert(a.toUpperCase()) : f),
                  e.sprites
              ...
              f = f.replace(l, function (f, o, l, r) {
                if (
                  ...
                  return f;
                (r = e.unescapeHTML(r)), (a = e.asciiList[r]);
          ...
          (e.toShort = function (f) {
            var _ = e.unicodeCharRegex();
            return (f = e.replaceAll(f, _));
          }),
          ...
          (e.shortnameConversionMap = function () {
            ...
            for (f in e.emojiList)
              e.emojiList.hasOwnProperty(f) &&
                '' !== f &&
                (_[e.convert(e.emojiList[f].uc_full)] = f);
            return _;
          }),
          (e.unicodeCharRegex = function () {
            if (!e.unicodeCharRegexCached) {
              ...
              for (f in e.emojiList)
                e.emojiList.hasOwnProperty(f) &&
                  '' !== f &&
                  _.push(e.convert(e.emojiList[f].uc_full));
              e.unicodeCharRegexCached = _.join('|');
            }
            return e.unicodeCharRegexCached;
          }),
          (e.mapEmojiList = function (f) {
            for (var _ in e.emojiList) {
              if (e.emojiList.hasOwnProperty(_)) f(e.emojiList[_].uc_full, _);
            }
          }),
          (e.mapUnicodeToShort = function () {
            return (
              e.memMapShortToUnicode ||
                ((e.memMapShortToUnicode = {}),
                e.mapEmojiList(function (f, _) {
                  e.memMapShortToUnicode[f] = _;
                })),
              e.memMapShortToUnicode
            );
          }),
          (e.memorizeReplacement = function () {
            if (
              ...
              var f = [];
              (e.memMapShortToUnicodeCharacters = {}),
                e.mapEmojiList(function (_, a) {
                  var o = e.convert(_);
                  (e.memMapShortToUnicodeCharacters[o] = a), f.push(o);
                }),
          ...
          (e.objectFlip = function (e) {
            var f,
              _ = {};
            for (f in e) e.hasOwnProperty(f) && (_[e[f]] = f);
            return _;
          }),
          (e.escapeRegExp = function (e) {
            return e.replace(/[-[\]{}()*+?.,;:&\\^$#\s]/g, '\\$&');
          }),
          (e.replaceAll = function (f, _) {
            var a = e.escapeRegExp(_),
              o = new RegExp(
                '<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(' +
                  a +
                  ')',
            ...
            return f.replace(o, function (f, _) {
