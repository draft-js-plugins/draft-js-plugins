      ...
      <div>
        ...
        <AlternateContainer>
          <p className={styles.whatText}>
            ...
            and many more features out of the box to enhance your web
            application.
          </p>
          ...
          <div className={styles.teamSection}>
            ...
            <div className={styles.teamMember}>
              ...
              >
                <img
                  className={styles.teamImage}
                  src="https://pbs.twimg.com/profile_images/763033229993574400/6frGyDyA_200x200.jpg"
                  role="presentation"
                />
                <div>Max Stoiber</div>
              </ExternalLink>
            ...
            <div className={styles.teamMember}>
              ...
              >
                <img
                  className={styles.teamImage}
                  src="https://pbs.twimg.com/profile_images/897291221714034688/zwMWApqh_400x400.jpg"
                  role="presentation"
                />
                <div>Adrian Li</div>
              </ExternalLink>
