...
// Export
export default setEntityData => WrappedComponent => {
  const { pluginOptions } = WrappedComponent;
  if (!pluginOptions || !pluginOptions.resizeable) {
    return WrappedComponent;
  }

  return class BlockResizeableDecorator extends Component {
    // Statics
    ...
    render() {
      ...
      if (pluginOptions && pluginOptions.customHandleResizeable) {
