...
module.exports = {
  resolve: {
    alias: {
      ...
      'draft-js-entity-props-plugin': path.join(__dirname, '..', 'draft-js-entity-props-plugin', 'src'),
      'draft-js-cleanup-empty-plugin': path.join(__dirname, '..', 'draft-js-cleanup-empty-plugin', 'src'),
      'draft-js-air-toolbar-plugin': path.join(__dirname, '..', 'draft-js-air-toolbar-plugin', 'src'),
    ...
    loaders: [
      {
        ...
        include: [
          ...
          path.join(__dirname, '..', 'draft-js-air-toolbar-plugin', 'src'),
          path.join(__dirname, '..', 'draft-js-entity-props-plugin', 'src'),
          path.join(__dirname, '..', 'draft-js-cleanup-empty-plugin', 'src'),
