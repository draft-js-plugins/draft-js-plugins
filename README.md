...
We are currently preparing for a 2.0 release. The `master` branch contains these features. All the packages are already published with a beta tag. Install it via `$ npm install <plugin>@2.0.0-rc7 --save`.
...
```
$ npm install draft-js-plugins-editor@2.0.0-rc7 --save
```
